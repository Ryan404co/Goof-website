<section class="footer-section">
	<div class="footer-container">
		<div class="footer-left">
			<h2>samenwerken?</h2>
			<p>
				Neem contact op voor een vrijblijvende offerte, een kennismakingsgesprek, of als je
				gewoon een vraag hebt!
			</p>
			<a href="/contact" class="footer-cta-button">let's goof</a>
		</div>
		...
		<div class="footer-right">
			<div class="footer-info-grid">
				<div class="footer-info-item">
					<h3>mailen</h3>
					<p><a href="mailto:info@goof.design">info@goof.design</a></p>
				</div>

				<div class="footer-info-item">
					<h3>bellen</h3>
					<p><a href="tel:+31624576082">+31 6 24576082</a></p>
				</div>
